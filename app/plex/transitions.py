...
class TransitionMap:
    ...
    def split(self, code, len=len, maxint=sys.maxsize):
        """
    ...
    def dump_range(self, code0, code1, set, file):
        if set:
            if code0 == -sys.maxsize:
                if code1 == sys.maxsize:
                    k = "any"
                else:
                    k = "< %s" % self.dump_char(code1)
            elif code1 == sys.maxsize:
