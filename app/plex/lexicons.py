...
from app.plex import actions
from app.plex import dfa as DFA
from app.plex import errors
from app.plex import machines
from app.plex import regexps
import collections
...
class Lexicon:
    ...
    def __init__(self, specifications, debug=None,
        ...
        if timings:
            from app.plex.timing import time
            total_time = 0.0
            time1 = time()
    ...
    def add_token_to_machine(self, machine, initial_state, token_spec,
        ...
        try:
            ...
            elif isinstance(action_spec, collections.Callable):
